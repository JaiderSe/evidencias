...
select count(distinct(CountryCode)) from countrylanguage where(language="French");
select count(distinct(CountryCode)) from countrylanguage where(language="French" and IsOfficial="T");
select*from countrylanguage;

show tables;
select*from city;

select name, ifnull(IndepYear,"no tiene") as Año_independencia from country;
select count(*) from country;
select count(distinct(CountryCode)) from countrylanguage where(language="French");
select name as NombrePais, ifnull(IndepYear,"no tiene") as Año_independencia from country where Continent ='South America' order by IndepYear ASC;
select*from countrylanguage where CountryCode="AND";
select 
	CountryCode as codigo,
	Language as lenguaje, 
	IsOfficial as idioma_oficial,
	Percentage as porcentaje
from countrylanguage where CountryCode="AND";

select concat(name,"-",region) as pais_region from country;


SELECT language, Percentage,
CASE
    WHEN IsOfficial="T" THEN concat(language," Es un idioma oficial")
    WHEN IsOfficial="F" THEN concat(language," No es un idioma oficial")
END as message_optional
FROM countrylanguage where CountryCode="AND";


SELECT count(*) as AñoIndependencia from country where (IndepYear>1800);

SELECT count(*) as Cantidad, IndepYear
From country
where IndepYear is not null
Group by IndepYear
Order BY IndepYear ASC;

 SELECT count(*) as PaisesSudamericanos from country where (Continent = "South America");
 
 SELECT Name as PaisesConK from country where (Name like "__K%");
 
 SELECT Name as city from city where (Name like "%A") order by name asc;

 SELECT Name as city from city where (Name like "A___") order by name asc;

 SELECT Name as city from city where (Name like "__r%") order by name asc;

 SELECT Name as city from city where (Name like "A%O") order by name asc;

 SELECT Name as city from city where (Name like "A___%") order by name asc;

 select count(Name) from city where (Name like "B%") order by name asc;
